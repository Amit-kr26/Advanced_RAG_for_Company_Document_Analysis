...
class PageTextPreparation:
    def __init__(self, use_serialized_tables: bool = False, serialized_tables_instead_of_markdown: bool = False):
        ...
        Args:
            use_serialized_tables (bool): Whether to use serialized table data. Defaults to False.
            serialized_tables_instead_of_markdown (bool): Whether to replace markdown with serialized text. Defaults to False.
        """
    ...
    def process_reports(
        ...
        Args:
            reports_dir (Path, optional): Directory containing the JSON report files. Defaults to None.
            reports_paths (List[Path], optional): List of paths to JSON report files. Defaults to None.
            output_dir (Path, optional): Directory where processed reports will be saved. Defaults to None.
    ...
    def process_report(self, report_data):
        ...
        Args:
            report_data (dict): The raw report data from a JSON file.

        Returns:
            dict: Processed report with pages and placeholder for chunks.
        """
    ...
    def prepare_page_text(self, page_number):
        ...
        Returns:
            str: The formatted and assembled text for the page.
        """
    ...
    def _get_page_data(self, page_number):
        ...
        Returns:
            dict: The page data, or None if the page is not found.
        """
    ...
    def _filter_blocks(self, blocks):
        ...
        Args:
            blocks (List[dict]): List of block data from the page.

        Returns:
            List[dict]: Filtered list of blocks, excluding ignored types.
        """
    ...
    def _clean_text(self, text):
        ...
        Returns:
            Tuple[str, int, List[Tuple[str, str]]]: Cleaned text, number of corrections, and list of correction pairs.
        """
        command_mapping = {
            'zero': '0',
            'one': '1', 
    ...
    def _block_ends_with_colon(self, block):
        ...
        Args:
            block (dict): The block data to check.

        Returns:
            bool: True if the block ends with a colon and is of a relevant type.
        """
        block_type = block.get("type")
    ...
    def _apply_formatting_rules(self, blocks):
        ...
        Args:
            blocks (List[dict]): List of filtered block data.

        Returns:
            List[str]: List of formatted text blocks.
        """
    ...
    def _render_table_group(self, group_blocks):
        ...
        Args:
            group_blocks (List[dict]): List of blocks in the table group.

        Returns:
            str: Formatted text for the table group.
        """
        chunk = []
    ...
    def _render_list_group(self, group_blocks):
        ...
        Args:
            group_blocks (List[dict]): List of blocks in the list group.

        Returns:
            str: Formatted text for the list group.
        """
        chunk = []
        for blk in group_blocks:
            blk_type = blk.get("type")
    ...
    def _get_table_by_id(self, table_id):
        ...
        Returns:
            str: Markdown or serialized text representation of the table.
        """
    ...
    def _get_serialized_table_text(self, table, serialized_tables_instead_of_markdown):
        ...
        Args:
            table (dict): Table object containing serialized data.
            serialized_tables_instead_of_markdown (bool): Whether to use serialized text instead of markdown.

        Returns:
            str: Concatenated information blocks or markdown as fallback.
        """
    ...
    def export_to_markdown(self, reports_dir: Path, output_dir: Path):
        ...
        Args:
            reports_dir (Path): Directory containing JSON report files.
